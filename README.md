...
[![Build Status](https://travis-ci.org/hristoandreev/OpenPLC_v3.svg?branch=master)](https://travis-ci.org/hristoandreev/OpenPLC_v3)
[![Build status](https://ci.appveyor.com/api/projects/status/ut3466ixwtyf68qg?svg=true)](https://ci.appveyor.com/project/hristoandreev/openplc-v3)
...
1. [Runtime](https://github.com/hristoandreev/OpenPLC_v3)
2. [Programming editor](https://openplcproject.com/docs/installing-openplc-editor/)


## Installation:
```bash
git clone https://github.com/hristoandreev/OpenPLC_v3.git
cd OpenPLC_v3
./install.sh [platform]
```
