...
const int customRTSPinMask = 27; // Added by Hristo Andreev
...
//============== Added by Hristo Andreev ============================
	if (pinNotPresent(ignored_bool_outputs, ARRAY_SIZE(ignored_bool_outputs), customRTSPinMask))
		pinMode(customRTSPinMask, OUTPUT);
//===================================================================
...
void setModbusCustomRTS(int on) {
	if (pinNotPresent(ignored_bool_outputs, ARRAY_SIZE(ignored_bool_outputs), customRTSPinMask))
		digitalWrite(customRTSPinMask, on);
}
//===================================================================